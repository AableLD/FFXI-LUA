...
function init_gear_sets()
    ...
    sets.precast.JA.Meditate = {neck="Republican Platinum Medal", head="Wakido Kabuto +2",hands={ name="Sakonji Kote +1", augments={'Enhances "Blade Bash" effect',}},back={ name="Smertrios's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Store TP"+10','Damage Taken-5%',}},}
	...
	sets.CP = {neck={ name="Sam. Nodowa +1", augments={'Path: A',}}}
