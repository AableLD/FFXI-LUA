...
function get_sets()
    ...
    back={ name="Lugh's Cape", augments={'"Fast Cast"+10','Damage taken-5%',}},}

    -- Your idle Sublimation set combine from refresh or DT depening on mode.
    sets.me.idle.sublimation = set_combine(sets.me.idle.refresh,{main="Mpaca's Staff",
    sub="Khonsu",
    ammo="Homiliary",
    head="Acad. Mortar. +4",
    ...
    -- Your idle DT set
    sets.me.idle.dt = set_combine(sets.me.idle[refreshType],{main="Mpaca's Staff",
    sub="Khonsu",
    ammo="Homiliary",
    head="Null Masque",
    body="Acad. Gown +4",
    ...
    sets.me.idle.mdt = set_combine(sets.me.idle[refreshType],{main="Mpaca's Staff",
    sub="Khonsu",
    ammo="Homiliary",
    head="Null Masque",
    body="Acad. Gown +4",
	...
	sets.precast["Stun"] = {main={ name="Grioavolr", augments={'Pet: "Dbl.Atk."+3 Pet: Crit.hit rate +3','"Fast Cast"+4',}},
    sub="Khonsu",
    ammo="Sapience Orb",
    head="Acad. Mortar. +4",
    body="Acad. Gown +4",
    ...
    sets.precast.stoneskin = set_combine(sets.precast.enhancing,{main={ name="Pedagogy Staff", augments={'Path: C',}},
    sub="Khonsu",
    ammo="Sapience Orb",
    head="Befouled Crown",
    body="Pedagogy Gown +2",
 ...
 back={ name="Lugh's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','Magic Damage +10','"Mag.Atk.Bns."+10','Spell interruption rate down-8%',}},
    ...
    sets.precast.cure = set_combine(sets.precast.casting,{main="Daybreak",
...
back={ name="Lugh's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','Magic Damage +10','"Mag.Atk.Bns."+10','Spell interruption rate down-8%',}},
    ...
    sets.midcast.casting = {main="Bunzi's Rod",
    sub="Ammurapi Shield",
    ammo="Ghastly Tathlum +1",
    head="Arbatel Bonnet +2",
    body="Arbatel gown +2",
...
back={ name="Lugh's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','Magic Damage +10','"Mag.Atk.Bns."+10','Spell interruption rate down-8%',}},    })	
    ...
    sets.midcast.IntEnfeebling = {main="Mpaca's Staff",
    sub="Khonsu",
    ammo="Ghastly Tathlum +1",
    head="Acad. Mortar. +4",
    body="Acad. Gown +4",
